...
export function LaptopSvg({ active, seen = false, booting = false }) {
  if (booting) {
    return (
      <svg viewBox="0 0 220 150" className="w-full" aria-hidden="true">
        ...
        <text x="110" y="66" textAnchor="middle" fontSize="26" fill="#ff7a59">✦</text>
  ...
  return (
    <svg viewBox="0 0 220 150" className="w-full" aria-hidden="true">
      ...
      {/* screen */}
      <rect x="35" y="10" width="150" height="100" rx="10" fill="#3b3833" />
      <rect x="42" y="17" width="136" height="86" rx="6" fill={active ? '#fffdf8' : '#f3ecdd'} />
      ...
      {seen && (
        <g>
          <rect x="66" y="30" width="108" height="64" rx="5" fill="#fffdf8" stroke="#d8cfbd" />
          <rect x="66" y="30" width="108" height="12" rx="5" fill="#b9a7f2" />
          <circle cx="73" cy="36" r="2" fill="#fff6ea" />
          <circle cx="80" cy="36" r="2" fill="#fff6ea" />
          <rect x="73" y="49" width="52" height="5" rx="2.5" fill="#8f77e0" />
          <rect x="73" y="59" width="90" height="3.5" rx="1.75" fill="#c9c2b4" />
          <rect x="73" y="66" width="80" height="3.5" rx="1.75" fill="#c9c2b4" />
          <rect x="73" y="76" width="34" height="10" rx="5" fill="#ff7a59" />
        </g>
      )}
      <defs>
      ...
      <rect x="50" y="25" width="26" height="7" rx="2" fill="#ff7a59" />
      <rect x="50" y="38" width="54" height="4" rx="2" fill="#c9c2b4" />
      <rect x="50" y="46" width="42" height="4" rx="2" fill="#c9c2b4" />
      {/* folder icons */}
      <g>
        <rect x="118" y="34" width="18" height="13" rx="2.5" fill="#b9a7f2" />
        <rect x="118" y="31" width="9" height="5" rx="2" fill="#b9a7f2" />
        <rect x="144" y="34" width="18" height="13" rx="2.5" fill="#ffc94d" />
        <rect x="144" y="31" width="9" height="5" rx="2" fill="#ffc94d" />
        <rect x="118" y="56" width="18" height="13" rx="2.5" fill="#7fd8be" />
        <rect x="118" y="53" width="9" height="5" rx="2" fill="#7fd8be" />
        <rect x="144" y="56" width="18" height="13" rx="2.5" fill="#8ecae6" />
        <rect x="144" y="53" width="9" height="5" rx="2" fill="#8ecae6" />
      </g>
      <rect x="50" y="60" width="56" height="34" rx="4" fill="#eee5d2" />
      <rect x="55" y="66" width="30" height="4" rx="2" fill="#ff7a59" />
...
export function NotebookSvg({ active, seen = false }) {
  return (
    <svg viewBox="0 0 150 110" className="w-full" aria-hidden="true">
      ...
      <rect x="14" y="18" width="122" height="78" rx="8" fill="#e85d3d" />
      <rect x="14" y="18" width="122" height="78" rx="8" fill="url(#nbShade)" />
      <defs>
        <linearGradient id="nbShade" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#ff7a59" />
          <stop offset="100%" stopColor="#e85d3d" />
        </linearGradient>
      </defs>
      {/* spiral binding */}
      {[...Array(7)].map((_, i) => (
        <circle key={i} cx={26} cy={28 + i * 10} r="3" fill="none" stroke="#fff6ea" strokeWidth="2" />
      ))}
      {/* elastic band */}
      <rect x="112" y="18" width="6" height="78" fill="#ffc94d" />
      {/* label */}
      <rect x="44" y="42" width="52" height="26" rx="4" fill="#fff6ea" />
      ...
      {seen && <rect x="58" y="10" width="16" height="12" rx="2" fill="#7fd8be" transform="rotate(-6 66 16)" />}
      {/* pencil resting on top */}
      <g transform="rotate(-18 40 20)">
        <rect x="30" y="6" width="52" height="6" rx="3" fill="#ffc94d" />
...
export function MugSvg({ active, seen = false }) {
  return (
    <svg viewBox="0 0 90 100" className="w-full overflow-visible" aria-hidden="true">
      ...
      {/* body */}
      <path d="M16 44h52v30a14 14 0 0 1-14 14H30a14 14 0 0 1-14-14z" fill="#8f77e0" />
      <path d="M16 44h52v8H16z" fill="#7a63cc" />
      <ellipse cx="42" cy="44" rx="26" ry="6" fill="#6b55bb" />
      <ellipse cx="42" cy="44" rx="21" ry="4.4" fill="#5b3f2e" />
      {/* handle */}
      <path d="M68 50c10 0 14 6 12 13-2 8-9 11-15 10" fill="none" stroke="#8f77e0" strokeWidth="7" strokeLinecap="round" />
      {/* heart */}
      <path d="M36 62c0-3 2.5-5 5-5s5 2 5 5c0 4-5 7-5 7s-5-3-5-7z" transform="translate(1 2)" fill="#fff6ea" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 220 110" className="w-full" aria-hidden="true">
      ...
      <g className={active ? 'drop-shadow-[0_0_8px_rgba(255,201,77,0.9)]' : ''}>
        <path d="M42 34h32v14a16 16 0 0 1-32 0z" fill="#ffc94d" />
        <path d="M42 38c-8 0-12 4-11 9 1 6 6 8 12 8M74 38c8 0 12 4 11 9-1 6-6 8-12 8" stroke="#e8a91d" strokeWidth="4" fill="none" />
        <rect x="53" y="62" width="10" height="10" fill="#e8a91d" />
        <rect x="45" y="72" width="26" height="8" rx="2" fill="#b57e45" />
        <rect x="45" y="80" width="26" height="8" rx="2" fill="#8a5f31" />
        {active && <circle cx="50" cy="40" r="2.5" fill="#fffdf8" opacity="0.9" />}
      </g>
      {/* medal */}
      <g>
        <path d="M110 30l8 20h-16z" fill="#ff7a59" />
        <circle cx="110" cy="60" r="14" fill="#ffc94d" stroke="#e8a91d" strokeWidth="3" />
...
export function BookshelfSvg() {
  ...
  return (
    <svg viewBox="0 0 130 90" className="w-full" aria-hidden="true">
      ...
      <g className="sway">
        <path d="M108 62q-3-12 4-18M112 64q1-10 9-13" stroke="#3fae90" strokeWidth="3" fill="none" strokeLinecap="round" />
      </g>
      <path d="M104 64h16l-2 12h-12z" fill="#e85d3d" />
    </svg>
  )
}
    ...
    <svg viewBox="0 0 150 90" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.6s ease', transform: stretching ? 'scaleX(1.14) translateX(-6px)' : 'none', transformOrigin: '75px 80px' }}>
        ...
        {night ? (
          ...
          <g>
            <path d="M25 29 C30 11, 50 3, 67 9 L59 30 C48 21, 36 23, 25 29 Z" fill="#8f77e0" />
            <path d="M52 12 C58 6, 66 6, 69 11" stroke="#8f77e0" strokeWidth="8" fill="none" strokeLinecap="round" />
            {/* trim band */}
            <path d="M24 30 Q43 19 62 29" stroke="#fff6ea" strokeWidth="6" fill="none" strokeLinecap="round" />
            {/* pompom drooping off the tip */}
            <circle cx="71" cy="13" r="5" fill="#fff6ea" />
            {/* a drowsy z drifting up */}
            <text x="80" y="26" fontFamily="Caveat, cursive" fontSize="13" fontWeight="700" fill="#b9a7f2">z</text>
            <text x="88" y="16" fontFamily="Caveat, cursive" fontSize="10" fontWeight="700" fill="#b9a7f2" opacity="0.7">z</text>
          </g>
        ) : (
          /* ears */
          <g>
            ...
            <path d="M28 30l-2-7 7 3z" fill="#e8a3a3" />
          </g>
        )}
        {/* face */}
        <g>
          ...
          {eyeOpen ? (
            <>
              <circle cx="34" cy="46" r="3.4" fill="#ffc94d" />
          ...
          {/* nose + whiskers */}
          <path d="M40 54l3 3 3-3z" fill="#e8a3a3" />
  ...
  return (
    <svg viewBox="0 0 130 85" className="w-full" aria-hidden="true">
      ...
      <path
        ...
        fill="#4a9fce"
      />
      <path d="M30 22h70q16 0 20 18l1 6H10l0-6q4-18 20-18z" fill="#8ecae6" opacity="0.45" />
      {/* d-pad */}
      <rect x="32" y="36" width="8" height="22" rx="2.5" fill="#fff6ea" />
      <rect x="25" y="43" width="22" height="8" rx="2.5" fill="#fff6ea" />
      {/* buttons — pulse when active */}
      <g>
        <circle cx="88" cy="38" r={active ? 5.6 : 4.6} fill="#ffc94d" style={{ transition: 'all 0.25s' }} />
        <circle cx="99" cy="47" r={active ? 5.6 : 4.6} fill="#ff7a59" style={{ transition: 'all 0.25s 0.08s' }} />
        <circle cx="77" cy="47" r={active ? 5.6 : 4.6} fill="#7fd8be" style={{ transition: 'all 0.25s 0.16s' }} />
        <circle cx="88" cy="56" r={active ? 5.6 : 4.6} fill="#b9a7f2" style={{ transition: 'all 0.25s 0.24s' }} />
      </g>
...
export function PaletteSvg({ active }) {
  const drops = [
    { cx: 38, cy: 32, c: '#ff7a59' },
    { cx: 58, cy: 24, c: '#ffc94d' },
    { cx: 78, cy: 28, c: '#7fd8be' },
    { cx: 92, cy: 42, c: '#8ecae6' },
    { cx: 88, cy: 60, c: '#b9a7f2' },
  ]
  return (
    <svg viewBox="0 0 130 95" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g transform="rotate(24 100 70)">
        ...
        <path d="M86 62q-9 1-12 3 3 2.5 12 3.5z" fill="#ff7a59" />
      </g>
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 120 90" className="w-full" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s ease', transform: active ? 'translate(8px,-8px) rotate(6deg)' : 'rotate(3deg)', transformOrigin: '80px 40px' }}>
        <rect x="42" y="14" width="66" height="44" rx="4" fill="#fffdf8" stroke="#e0d7c5" />
        <path d="M46 44l14-14 10 8 12-12 18 18v10H46z" fill="#7fd8be" opacity="0.7" />
        <circle cx="94" cy="24" r="5" fill="#ffc94d" />
        <rect x="94" y="18" width="10" height="12" rx="1" fill="#ff7a59" opacity="0.85" />
      </g>
      {/* passport */}
      <rect x="14" y="30" width="58" height="50" rx="6" fill="#3fae90" />
      <rect x="14" y="30" width="58" height="50" rx="6" fill="url(#ppShade)" />
      <defs>
        <linearGradient id="ppShade" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#7fd8be" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#3fae90" stopOpacity="0" />
        </linearGradient>
      </defs>
      <circle cx="43" cy="49" r="9" fill="none" stroke="#fff6ea" strokeWidth="2" />
      <path d="M34 49h18M43 40c4 5 4 13 0 18M43 40c-4 5-4 13 0 18" stroke="#fff6ea" strokeWidth="1.6" fill="none" />
      <text x="43" y="72" textAnchor="middle" fontSize="8" fontWeight="700" fill="#fff6ea" letterSpacing="1.5">
        PASSPORT
      </text>
    </svg>
  )
    ...
    <svg viewBox="0 0 110 100" className="w-full" aria-hidden="true">
      {seen ? (
        ...
        <g transform="rotate(-5 30 30)">
          <rect x="8" y="10" width="42" height="42" rx="2" fill="#ffc94d" />
      ...
      <g transform={active ? 'rotate(7 78 34) translate(0 -3)' : 'rotate(4 78 34)'} style={{ transition: 'all 0.3s' }}>
        <rect x="56" y="14" width="42" height="42" rx="2" fill="#7fd8be" />
      ...
      <g transform={active ? 'rotate(-9 52 74) translate(0 -4)' : 'rotate(-3 52 74)'} style={{ transition: 'all 0.3s 0.06s' }}>
        <rect x="32" y="52" width="42" height="42" rx="2" fill="#ffa8c5" />
...
export function PlantSvg() {
  return (
    <svg viewBox="0 0 110 160" className="w-full" aria-hidden="true">
      ...
      <g className="sway">
        <path d="M55 105Q30 80 34 44" stroke="#3fae90" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M55 105Q78 76 74 40" stroke="#3fae90" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M55 105Q55 70 55 34" stroke="#3fae90" strokeWidth="5" fill="none" strokeLinecap="round" />
        <ellipse cx="34" cy="40" rx="12" ry="20" fill="#7fd8be" transform="rotate(-18 34 40)" />
        <ellipse cx="55" cy="28" rx="12" ry="22" fill="#5fc7a8" />
        <ellipse cx="75" cy="36" rx="12" ry="20" fill="#7fd8be" transform="rotate(16 75 36)" />
        <ellipse cx="43" cy="70" rx="10" ry="16" fill="#5fc7a8" transform="rotate(-30 43 70)" />
        <ellipse cx="68" cy="68" rx="10" ry="16" fill="#7fd8be" transform="rotate(28 68 68)" />
      </g>
      <path d="M30 104h50l-6 48H36z" fill="#e85d3d" />
      <path d="M30 104h50l-1.5 12h-47z" fill="#ff7a59" />
    </svg>
  )
}
...
export function LampSvg({ night = false }) {
  return (
    <svg viewBox="0 0 130 150" className="w-full overflow-visible" aria-hidden="true">
      ...
      {night && <ellipse cx="80" cy="55" rx="26" ry="14" fill="#ffe9b3" opacity="0.55" style={{ filter: 'blur(6px)' }} />}
      <defs>
      ...
      <g transform="rotate(38 80 48)">
        <path d="M62 38h38a4 4 0 0 1 4 4l-6 14H64l-6-14a4 4 0 0 1 4-4z" fill="#ff7a59" />
        <ellipse cx="81" cy="56" rx="18" ry="5" fill="#ffe9b3" />
      </g>
      {/* base */}
  ...
  return (
    <svg viewBox="0 0 150 70" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s cubic-bezier(.34,1.56,.64,1)', transform: active ? 'translateY(-7px)' : 'none' }}>
        ...
        {(active || seen) && <rect x="20" y="2" width="34" height="12" rx="2" fill="#fffdf8" stroke="#d8cfbd" transform="rotate(-4 37 8)" />}
        {seen && <rect x="104" y="4" width="22" height="10" rx="2" fill="#ffc94d" transform="rotate(5 115 9)" />}
      </g>
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 120 80" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s cubic-bezier(.34,1.56,.64,1)', transform: active ? 'translateY(-10px) rotate(-8deg)' : 'none', transformOrigin: '60px 45px' }}>
        <path d="M12 48 L106 16 L66 62 Z" fill="#fffdf8" stroke="#d8cfbd" strokeWidth="1.5" />
        ...
        <path d="M78 32c0-2.4 2-4 4-4s4 1.6 4 4c0 3.2-4 5.6-4 5.6s-4-2.4-4-5.6z" fill="#ff7a59" opacity="0.9" />
      </g>
      {active && (
        <path d="M14 62q10-4 20-1" stroke="#8ecae6" strokeWidth="2" strokeDasharray="4 4" fill="none" strokeLinecap="round" />
      )}
    </svg>
  )
}
