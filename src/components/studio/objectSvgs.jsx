    ...
    <svg viewBox="0 0 220 150" className="w-full" aria-hidden="true">
      ...
      {seen && (
        <g>
          ...
          <rect x="66" y="30" width="108" height="12" rx="5" fill="#7c98cc" />
          <circle cx="73" cy="36" r="2" fill="#faf6ee" />
          <circle cx="80" cy="36" r="2" fill="#faf6ee" />
          <rect x="73" y="49" width="52" height="5" rx="2.5" fill="#4a69a8" />
      ...
      <defs>
        <radialGradient id="lapGlow" cx="0.5" cy="0.4" r="0.8">
          <stop offset="0%" stopColor="#f3e3b8" stopOpacity="0.9" />
      ...
      {/* folder icons */}
      <g>
        <rect x="118" y="34" width="18" height="13" rx="2.5" fill="#7c98cc" />
        <rect x="118" y="31" width="9" height="5" rx="2" fill="#7c98cc" />
        <rect x="144" y="34" width="18" height="13" rx="2.5" fill="#e0a33c" />
        <rect x="144" y="31" width="9" height="5" rx="2" fill="#e0a33c" />
        <rect x="118" y="56" width="18" height="13" rx="2.5" fill="#77b295" />
        <rect x="118" y="53" width="9" height="5" rx="2" fill="#77b295" />
...
export function NotebookSvg({ active, seen = false }) {
  return (
    <svg viewBox="0 0 150 110" className="w-full" aria-hidden="true">
      ...
      {/* spiral binding */}
      {[...Array(7)].map((_, i) => (
        <circle key={i} cx={26} cy={28 + i * 10} r="3" fill="none" stroke="#faf6ee" strokeWidth="2" />
      ))}
      {/* elastic band */}
      <rect x="112" y="18" width="6" height="78" fill="#e0a33c" />
      {/* label */}
      <rect x="44" y="42" width="52" height="26" rx="4" fill="#faf6ee" />
      ...
      {seen && <rect x="58" y="10" width="16" height="12" rx="2" fill="#77b295" transform="rotate(-6 66 16)" />}
      {/* pencil resting on top */}
      <g transform="rotate(-18 40 20)">
        <rect x="30" y="6" width="52" height="6" rx="3" fill="#e0a33c" />
...
export function MugSvg({ active, seen = false }) {
  return (
    <svg viewBox="0 0 90 100" className="w-full overflow-visible" aria-hidden="true">
      ...
      {/* body */}
      <path d="M16 44h52v30a14 14 0 0 1-14 14H30a14 14 0 0 1-14-14z" fill="#4a69a8" />
      <path d="M16 44h52v8H16z" fill="#5a6fa8" />
      <ellipse cx="42" cy="44" rx="26" ry="6" fill="#47598c" />
      <ellipse cx="42" cy="44" rx="21" ry="4.4" fill="#5b3f2e" />
      {/* handle */}
      <path d="M68 50c10 0 14 6 12 13-2 8-9 11-15 10" fill="none" stroke="#4a69a8" strokeWidth="7" strokeLinecap="round" />
      {/* heart */}
      <path d="M36 62c0-3 2.5-5 5-5s5 2 5 5c0 4-5 7-5 7s-5-3-5-7z" transform="translate(1 2)" fill="#faf6ee" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 220 110" className="w-full" aria-hidden="true">
      ...
      <g className={active ? 'drop-shadow-[0_0_8px_rgba(255,201,77,0.9)]' : ''}>
        <path d="M42 34h32v14a16 16 0 0 1-32 0z" fill="#e0a33c" />
        <path d="M42 38c-8 0-12 4-11 9 1 6 6 8 12 8M74 38c8 0 12 4 11 9-1 6-6 8-12 8" stroke="#a06f14" strokeWidth="4" fill="none" />
        <rect x="53" y="62" width="10" height="10" fill="#a06f14" />
      ...
      <g>
        ...
        <circle cx="110" cy="60" r="14" fill="#e0a33c" stroke="#a06f14" strokeWidth="3" />
...
export function BookshelfSvg() {
  ...
  return (
    <svg viewBox="0 0 130 90" className="w-full" aria-hidden="true">
      ...
      <g className="sway">
        <path d="M108 62q-3-12 4-18M112 64q1-10 9-13" stroke="#3f8a68" strokeWidth="3" fill="none" strokeLinecap="round" />
      </g>
    ...
    <svg viewBox="0 0 150 90" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.6s ease', transform: stretching ? 'scaleX(1.14) translateX(-6px)' : 'none', transformOrigin: '75px 80px' }}>
        ...
        {night ? (
          ...
          <g>
            <path d="M25 29 C30 11, 50 3, 67 9 L59 30 C48 21, 36 23, 25 29 Z" fill="#4a69a8" />
            <path d="M52 12 C58 6, 66 6, 69 11" stroke="#4a69a8" strokeWidth="8" fill="none" strokeLinecap="round" />
            {/* trim band */}
            <path d="M24 30 Q43 19 62 29" stroke="#faf6ee" strokeWidth="6" fill="none" strokeLinecap="round" />
            {/* pompom drooping off the tip */}
            <circle cx="71" cy="13" r="5" fill="#faf6ee" />
            {/* a drowsy z drifting up */}
            <text x="80" y="26" fontFamily="Caveat, cursive" fontSize="13" fontWeight="700" fill="#7c98cc">z</text>
            <text x="88" y="16" fontFamily="Caveat, cursive" fontSize="10" fontWeight="700" fill="#7c98cc" opacity="0.7">z</text>
          </g>
        ) : (
          /* ears */
          <g>
        ...
        <g>
          ...
          {eyeOpen ? (
            <>
              <circle cx="34" cy="46" r="3.4" fill="#e0a33c" />
...
export function ControllerSvg({ active }) {
  return (
    <svg viewBox="0 0 130 85" className="w-full" aria-hidden="true">
      ...
      {/* d-pad */}
      <rect x="32" y="36" width="8" height="22" rx="2.5" fill="#faf6ee" />
      <rect x="25" y="43" width="22" height="8" rx="2.5" fill="#faf6ee" />
      {/* buttons — pulse when active */}
      <g>
        <circle cx="88" cy="38" r={active ? 5.6 : 4.6} fill="#e0a33c" style={{ transition: 'all 0.25s' }} />
        <circle cx="99" cy="47" r={active ? 5.6 : 4.6} fill="#0a66c2" style={{ transition: 'all 0.25s 0.08s' }} />
        <circle cx="77" cy="47" r={active ? 5.6 : 4.6} fill="#77b295" style={{ transition: 'all 0.25s 0.16s' }} />
        <circle cx="88" cy="56" r={active ? 5.6 : 4.6} fill="#7c98cc" style={{ transition: 'all 0.25s 0.24s' }} />
      </g>
...
export function PaletteSvg({ active }) {
  const drops = [
    ...
    { cx: 58, cy: 24, c: '#e0a33c' },
    { cx: 78, cy: 28, c: '#77b295' },
    { cx: 92, cy: 42, c: '#85b8e8' },
    { cx: 88, cy: 60, c: '#7c98cc' },
  ]
  return (
  ...
  return (
    <svg viewBox="0 0 120 90" className="w-full" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s ease', transform: active ? 'translate(8px,-8px) rotate(6deg)' : 'rotate(3deg)', transformOrigin: '80px 40px' }}>
        ...
        <path d="M46 44l14-14 10 8 12-12 18 18v10H46z" fill="#77b295" opacity="0.7" />
        <circle cx="94" cy="24" r="5" fill="#e0a33c" />
        <rect x="94" y="18" width="10" height="12" rx="1" fill="#0a66c2" opacity="0.85" />
      </g>
      {/* passport */}
      <rect x="14" y="30" width="58" height="50" rx="6" fill="#3f8a68" />
      <rect x="14" y="30" width="58" height="50" rx="6" fill="url(#ppShade)" />
      <defs>
        <linearGradient id="ppShade" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#77b295" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#3f8a68" stopOpacity="0" />
        </linearGradient>
      </defs>
      <circle cx="43" cy="49" r="9" fill="none" stroke="#faf6ee" strokeWidth="2" />
      <path d="M34 49h18M43 40c4 5 4 13 0 18M43 40c-4 5-4 13 0 18" stroke="#faf6ee" strokeWidth="1.6" fill="none" />
      <text x="43" y="72" textAnchor="middle" fontSize="8" fontWeight="700" fill="#faf6ee" letterSpacing="1.5">
        PASSPORT
      </text>
    </svg>
  )
    ...
    <svg viewBox="0 0 110 100" className="w-full" aria-hidden="true">
      {seen ? (
        ...
        <g transform="rotate(-5 30 30)">
          <rect x="8" y="10" width="42" height="42" rx="2" fill="#e0a33c" />
      ...
      <g transform={active ? 'rotate(7 78 34) translate(0 -3)' : 'rotate(4 78 34)'} style={{ transition: 'all 0.3s' }}>
        <rect x="56" y="14" width="42" height="42" rx="2" fill="#77b295" />
...
export function PlantSvg() {
  return (
    <svg viewBox="0 0 110 160" className="w-full" aria-hidden="true">
      ...
      <g className="sway">
        <path d="M55 105Q30 80 34 44" stroke="#3f8a68" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M55 105Q78 76 74 40" stroke="#3f8a68" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M55 105Q55 70 55 34" stroke="#3f8a68" strokeWidth="5" fill="none" strokeLinecap="round" />
        <ellipse cx="34" cy="40" rx="12" ry="20" fill="#77b295" transform="rotate(-18 34 40)" />
        <ellipse cx="55" cy="28" rx="12" ry="22" fill="#5fa382" />
        <ellipse cx="75" cy="36" rx="12" ry="20" fill="#77b295" transform="rotate(16 75 36)" />
        <ellipse cx="43" cy="70" rx="10" ry="16" fill="#5fa382" transform="rotate(-30 43 70)" />
        <ellipse cx="68" cy="68" rx="10" ry="16" fill="#77b295" transform="rotate(28 68 68)" />
      </g>
...
export function LampSvg({ night = false }) {
  return (
    <svg viewBox="0 0 130 150" className="w-full overflow-visible" aria-hidden="true">
      ...
      {night && <ellipse cx="80" cy="55" rx="26" ry="14" fill="#f3e3b8" opacity="0.55" style={{ filter: 'blur(6px)' }} />}
      <defs>
        <linearGradient id="lampGlow" x1="0.5" y1="0" x2="0.5" y2="1">
          <stop offset="0%" stopColor="#f3e3b8" stopOpacity="0.85" />
          <stop offset="100%" stopColor="#f3e3b8" stopOpacity="0" />
        </linearGradient>
      </defs>
      {/* arm */}
      ...
      <g transform="rotate(38 80 48)">
        ...
        <ellipse cx="81" cy="56" rx="18" ry="5" fill="#f3e3b8" />
      </g>
      {/* base */}
  ...
  return (
    <svg viewBox="0 0 150 70" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s cubic-bezier(.34,1.56,.64,1)', transform: active ? 'translateY(-7px)' : 'none' }}>
        ...
        {seen && <rect x="104" y="4" width="22" height="10" rx="2" fill="#e0a33c" transform="rotate(5 115 9)" />}
      </g>
    </svg>
  )
}
...
export function CalendarSvg({ active = false }) {
  ...
  return (
    <svg viewBox="0 0 90 100" className="w-full" aria-hidden="true">
      ...
      {/* spiral rings */}
      {[0, 1, 2, 3, 4].map((i) => (
        <circle key={i} cx={26 + i * 9.5} cy="18" r="2.6" fill="none" stroke="#6b6760" strokeWidth="1.8" />
      ))}
      {/* month band */}
      <rect x="16" y="22" width="58" height="16" rx="5" fill="#0a66c2" />
      <text x="45" y="34" textAnchor="middle" fontSize="11" fontWeight="800" fill="#faf6ee" fontFamily="inherit" letterSpacing="2">
        {month}
      </text>
      {/* today's date */}
