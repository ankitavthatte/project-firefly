...
export function LaptopSvg({ active, seen = false, booting = false }) {
  if (booting) {
    return (
      <svg viewBox="0 0 220 150" className="w-full" aria-hidden="true">
        ...
        <text x="110" y="66" textAnchor="middle" fontSize="26" fill="#c26d52">✦</text>
  ...
  return (
    <svg viewBox="0 0 220 150" className="w-full" aria-hidden="true">
      ...
      {/* screen */}
      <rect x="35" y="10" width="150" height="100" rx="10" fill="#3b3833" />
      <rect x="42" y="17" width="136" height="86" rx="6" fill={active ? '#fdfbf6' : '#f3ecdd'} />
      ...
      {seen && (
        <g>
          <rect x="66" y="30" width="108" height="64" rx="5" fill="#fdfbf6" stroke="#d8cfbd" />
          <rect x="66" y="30" width="108" height="12" rx="5" fill="#a79ec4" />
          <circle cx="73" cy="36" r="2" fill="#f7f1e6" />
          <circle cx="80" cy="36" r="2" fill="#f7f1e6" />
          <rect x="73" y="49" width="52" height="5" rx="2.5" fill="#776c9d" />
          <rect x="73" y="59" width="90" height="3.5" rx="1.75" fill="#c9c2b4" />
          <rect x="73" y="66" width="80" height="3.5" rx="1.75" fill="#c9c2b4" />
          <rect x="73" y="76" width="34" height="10" rx="5" fill="#c26d52" />
        </g>
      )}
      <defs>
        <radialGradient id="lapGlow" cx="0.5" cy="0.4" r="0.8">
          <stop offset="0%" stopColor="#f0dfba" stopOpacity="0.9" />
          <stop offset="100%" stopColor="#f0dfba" stopOpacity="0" />
        </radialGradient>
      </defs>
      {/* tiny desktop UI on screen */}
      <rect x="50" y="25" width="26" height="7" rx="2" fill="#c26d52" />
      <rect x="50" y="38" width="54" height="4" rx="2" fill="#c9c2b4" />
      <rect x="50" y="46" width="42" height="4" rx="2" fill="#c9c2b4" />
      {/* folder icons */}
      <g>
        <rect x="118" y="34" width="18" height="13" rx="2.5" fill="#a79ec4" />
        <rect x="118" y="31" width="9" height="5" rx="2" fill="#a79ec4" />
        <rect x="144" y="34" width="18" height="13" rx="2.5" fill="#d3a955" />
        <rect x="144" y="31" width="9" height="5" rx="2" fill="#d3a955" />
        <rect x="118" y="56" width="18" height="13" rx="2.5" fill="#96b7a3" />
        <rect x="118" y="53" width="9" height="5" rx="2" fill="#96b7a3" />
        <rect x="144" y="56" width="18" height="13" rx="2.5" fill="#9db6c6" />
        <rect x="144" y="53" width="9" height="5" rx="2" fill="#9db6c6" />
      </g>
      <rect x="50" y="60" width="56" height="34" rx="4" fill="#eee5d2" />
      <rect x="55" y="66" width="30" height="4" rx="2" fill="#c26d52" />
...
export function NotebookSvg({ active, seen = false }) {
  return (
    <svg viewBox="0 0 150 110" className="w-full" aria-hidden="true">
      ...
      <rect x="14" y="18" width="122" height="78" rx="8" fill="#a05138" />
      <rect x="14" y="18" width="122" height="78" rx="8" fill="url(#nbShade)" />
      <defs>
        <linearGradient id="nbShade" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#c26d52" />
          <stop offset="100%" stopColor="#a05138" />
        </linearGradient>
      </defs>
      {/* spiral binding */}
      {[...Array(7)].map((_, i) => (
        <circle key={i} cx={26} cy={28 + i * 10} r="3" fill="none" stroke="#f7f1e6" strokeWidth="2" />
      ))}
      {/* elastic band */}
      <rect x="112" y="18" width="6" height="78" fill="#d3a955" />
      {/* label */}
      <rect x="44" y="42" width="52" height="26" rx="4" fill="#f7f1e6" />
      <text x="70" y="59" textAnchor="middle" fontFamily="Caveat, cursive" fontSize="15" fontWeight="700" fill="#35322d">
        process
      </text>
      ...
      {seen && <rect x="58" y="10" width="16" height="12" rx="2" fill="#96b7a3" transform="rotate(-6 66 16)" />}
      {/* pencil resting on top */}
      <g transform="rotate(-18 40 20)">
        <rect x="30" y="6" width="52" height="6" rx="3" fill="#d3a955" />
        <path d="M82 6l9 3-9 3z" fill="#d9a066" />
        <path d="M89.5 8.4l2.4 0.8-2.4 0.8z" fill="#35322d" />
      </g>
    </svg>
  )
}
...
export function MugSvg({ active, seen = false }) {
  return (
    <svg viewBox="0 0 90 100" className="w-full overflow-visible" aria-hidden="true">
      ...
      {/* body */}
      <path d="M16 44h52v30a14 14 0 0 1-14 14H30a14 14 0 0 1-14-14z" fill="#776c9d" />
      <path d="M16 44h52v8H16z" fill="#6d6396" />
      <ellipse cx="42" cy="44" rx="26" ry="6" fill="#5e5584" />
      <ellipse cx="42" cy="44" rx="21" ry="4.4" fill="#5b3f2e" />
      {/* handle */}
      <path d="M68 50c10 0 14 6 12 13-2 8-9 11-15 10" fill="none" stroke="#776c9d" strokeWidth="7" strokeLinecap="round" />
      {/* heart */}
      <path d="M36 62c0-3 2.5-5 5-5s5 2 5 5c0 4-5 7-5 7s-5-3-5-7z" transform="translate(1 2)" fill="#f7f1e6" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 220 110" className="w-full" aria-hidden="true">
      ...
      <g className={active ? 'drop-shadow-[0_0_8px_rgba(255,201,77,0.9)]' : ''}>
        <path d="M42 34h32v14a16 16 0 0 1-32 0z" fill="#d3a955" />
        <path d="M42 38c-8 0-12 4-11 9 1 6 6 8 12 8M74 38c8 0 12 4 11 9-1 6-6 8-12 8" stroke="#a8842f" strokeWidth="4" fill="none" />
        <rect x="53" y="62" width="10" height="10" fill="#a8842f" />
        <rect x="45" y="72" width="26" height="8" rx="2" fill="#b57e45" />
        <rect x="45" y="80" width="26" height="8" rx="2" fill="#8a5f31" />
        {active && <circle cx="50" cy="40" r="2.5" fill="#fdfbf6" opacity="0.9" />}
      </g>
      {/* medal */}
      <g>
        <path d="M110 30l8 20h-16z" fill="#c26d52" />
        <circle cx="110" cy="60" r="14" fill="#d3a955" stroke="#a8842f" strokeWidth="3" />
...
export function BookshelfSvg() {
  ...
  return (
    <svg viewBox="0 0 130 90" className="w-full" aria-hidden="true">
      ...
      <g className="sway">
        <path d="M108 62q-3-12 4-18M112 64q1-10 9-13" stroke="#628a74" strokeWidth="3" fill="none" strokeLinecap="round" />
      </g>
      <path d="M104 64h16l-2 12h-12z" fill="#a05138" />
    </svg>
  )
}
    ...
    <svg viewBox="0 0 150 90" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.6s ease', transform: stretching ? 'scaleX(1.14) translateX(-6px)' : 'none', transformOrigin: '75px 80px' }}>
        ...
        {night ? (
          ...
          <g>
            <path d="M25 29 C30 11, 50 3, 67 9 L59 30 C48 21, 36 23, 25 29 Z" fill="#776c9d" />
            <path d="M52 12 C58 6, 66 6, 69 11" stroke="#776c9d" strokeWidth="8" fill="none" strokeLinecap="round" />
            {/* trim band */}
            <path d="M24 30 Q43 19 62 29" stroke="#f7f1e6" strokeWidth="6" fill="none" strokeLinecap="round" />
            {/* pompom drooping off the tip */}
            <circle cx="71" cy="13" r="5" fill="#f7f1e6" />
            {/* a drowsy z drifting up */}
            <text x="80" y="26" fontFamily="Caveat, cursive" fontSize="13" fontWeight="700" fill="#a79ec4">z</text>
            <text x="88" y="16" fontFamily="Caveat, cursive" fontSize="10" fontWeight="700" fill="#a79ec4" opacity="0.7">z</text>
          </g>
        ) : (
          /* ears */
          <g>
            ...
            <path d="M28 30l-2-7 7 3z" fill="#cf9c96" />
          </g>
        )}
        {/* face */}
        <g>
          ...
          {eyeOpen ? (
            <>
              <circle cx="34" cy="46" r="3.4" fill="#d3a955" />
              <circle cx="34" cy="46" r="1.5" fill="#35322d" />
              <path d="M46 46q4 3 8 0" stroke="#35322d" strokeWidth="2.4" fill="none" strokeLinecap="round" />
            </>
          ) : (
            <>
              <path d="M30 46q4 3 8 0" stroke="#35322d" strokeWidth="2.4" fill="none" strokeLinecap="round" />
              <path d="M46 46q4 3 8 0" stroke="#35322d" strokeWidth="2.4" fill="none" strokeLinecap="round" />
            </>
          )}
          {/* nose + whiskers */}
          <path d="M40 54l3 3 3-3z" fill="#cf9c96" />
  ...
  return (
    <svg viewBox="0 0 130 85" className="w-full" aria-hidden="true">
      ...
      <path
        ...
        fill="#64869e"
      />
      <path d="M30 22h70q16 0 20 18l1 6H10l0-6q4-18 20-18z" fill="#9db6c6" opacity="0.45" />
      {/* d-pad */}
      <rect x="32" y="36" width="8" height="22" rx="2.5" fill="#f7f1e6" />
      <rect x="25" y="43" width="22" height="8" rx="2.5" fill="#f7f1e6" />
      {/* buttons — pulse when active */}
      <g>
        <circle cx="88" cy="38" r={active ? 5.6 : 4.6} fill="#d3a955" style={{ transition: 'all 0.25s' }} />
        <circle cx="99" cy="47" r={active ? 5.6 : 4.6} fill="#c26d52" style={{ transition: 'all 0.25s 0.08s' }} />
        <circle cx="77" cy="47" r={active ? 5.6 : 4.6} fill="#96b7a3" style={{ transition: 'all 0.25s 0.16s' }} />
        <circle cx="88" cy="56" r={active ? 5.6 : 4.6} fill="#a79ec4" style={{ transition: 'all 0.25s 0.24s' }} />
      </g>
      <circle cx="58" cy="52" r="5" fill="#35322d" opacity="0.5" />
      <circle cx="70" cy="34" r="3" fill="#35322d" opacity="0.35" />
    </svg>
  )
}
...
export function PaletteSvg({ active }) {
  const drops = [
    { cx: 38, cy: 32, c: '#c26d52' },
    { cx: 58, cy: 24, c: '#d3a955' },
    { cx: 78, cy: 28, c: '#96b7a3' },
    { cx: 92, cy: 42, c: '#9db6c6' },
    { cx: 88, cy: 60, c: '#a79ec4' },
  ]
  return (
    <svg viewBox="0 0 130 95" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g transform="rotate(24 100 70)">
        ...
        <path d="M86 62q-9 1-12 3 3 2.5 12 3.5z" fill="#c26d52" />
      </g>
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 120 90" className="w-full" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s ease', transform: active ? 'translate(8px,-8px) rotate(6deg)' : 'rotate(3deg)', transformOrigin: '80px 40px' }}>
        <rect x="42" y="14" width="66" height="44" rx="4" fill="#fdfbf6" stroke="#e0d7c5" />
        <path d="M46 44l14-14 10 8 12-12 18 18v10H46z" fill="#96b7a3" opacity="0.7" />
        <circle cx="94" cy="24" r="5" fill="#d3a955" />
        <rect x="94" y="18" width="10" height="12" rx="1" fill="#c26d52" opacity="0.85" />
      </g>
      {/* passport */}
      <rect x="14" y="30" width="58" height="50" rx="6" fill="#628a74" />
      <rect x="14" y="30" width="58" height="50" rx="6" fill="url(#ppShade)" />
      <defs>
        <linearGradient id="ppShade" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#96b7a3" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#628a74" stopOpacity="0" />
        </linearGradient>
      </defs>
      <circle cx="43" cy="49" r="9" fill="none" stroke="#f7f1e6" strokeWidth="2" />
      <path d="M34 49h18M43 40c4 5 4 13 0 18M43 40c-4 5-4 13 0 18" stroke="#f7f1e6" strokeWidth="1.6" fill="none" />
      <text x="43" y="72" textAnchor="middle" fontSize="8" fontWeight="700" fill="#f7f1e6" letterSpacing="1.5">
        PASSPORT
      </text>
    </svg>
  )
    ...
    <svg viewBox="0 0 110 100" className="w-full" aria-hidden="true">
      {seen ? (
        ...
        <g transform="rotate(-5 30 30)">
          <rect x="8" y="10" width="42" height="42" rx="2" fill="#d3a955" />
          <path d="M8 44l42 8v-8z" fill="rgba(53,50,45,0.08)" />
          <text x="29" y="34" textAnchor="middle" fontFamily="Caveat, cursive" fontSize="15" fontWeight="700" fill="#35322d">
            why?
          </text>
        </g>
      )}
      <g transform={active ? 'rotate(7 78 34) translate(0 -3)' : 'rotate(4 78 34)'} style={{ transition: 'all 0.3s' }}>
        <rect x="56" y="14" width="42" height="42" rx="2" fill="#96b7a3" />
        <text x="77" y="38" textAnchor="middle" fontFamily="Caveat, cursive" fontSize="13" fontWeight="700" fill="#35322d">
          simple!
        </text>
      </g>
      <g transform={active ? 'rotate(-9 52 74) translate(0 -4)' : 'rotate(-3 52 74)'} style={{ transition: 'all 0.3s 0.06s' }}>
        <rect x="32" y="52" width="42" height="42" rx="2" fill="#d69cab" />
        <text x="53" y="77" textAnchor="middle" fontFamily="Caveat, cursive" fontSize="13" fontWeight="700" fill="#35322d">
          feeling
        </text>
      </g>
    </svg>
...
export function PlantSvg() {
  return (
    <svg viewBox="0 0 110 160" className="w-full" aria-hidden="true">
      ...
      <g className="sway">
        <path d="M55 105Q30 80 34 44" stroke="#628a74" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M55 105Q78 76 74 40" stroke="#628a74" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M55 105Q55 70 55 34" stroke="#628a74" strokeWidth="5" fill="none" strokeLinecap="round" />
        <ellipse cx="34" cy="40" rx="12" ry="20" fill="#96b7a3" transform="rotate(-18 34 40)" />
        <ellipse cx="55" cy="28" rx="12" ry="22" fill="#7da58e" />
        <ellipse cx="75" cy="36" rx="12" ry="20" fill="#96b7a3" transform="rotate(16 75 36)" />
        <ellipse cx="43" cy="70" rx="10" ry="16" fill="#7da58e" transform="rotate(-30 43 70)" />
        <ellipse cx="68" cy="68" rx="10" ry="16" fill="#96b7a3" transform="rotate(28 68 68)" />
      </g>
      <path d="M30 104h50l-6 48H36z" fill="#a05138" />
      <path d="M30 104h50l-1.5 12h-47z" fill="#c26d52" />
    </svg>
  )
}
...
export function LampSvg({ night = false }) {
  return (
    <svg viewBox="0 0 130 150" className="w-full overflow-visible" aria-hidden="true">
      ...
      {night && <ellipse cx="80" cy="55" rx="26" ry="14" fill="#f0dfba" opacity="0.55" style={{ filter: 'blur(6px)' }} />}
      <defs>
        <linearGradient id="lampGlow" x1="0.5" y1="0" x2="0.5" y2="1">
          <stop offset="0%" stopColor="#f0dfba" stopOpacity="0.85" />
          <stop offset="100%" stopColor="#f0dfba" stopOpacity="0" />
        </linearGradient>
      </defs>
      {/* arm */}
      <path d="M40 138 L52 84 L76 52" stroke="#524e47" strokeWidth="7" fill="none" strokeLinecap="round" />
      <circle cx="52" cy="84" r="5" fill="#35322d" />
      {/* head */}
      <g transform="rotate(38 80 48)">
        <path d="M62 38h38a4 4 0 0 1 4 4l-6 14H64l-6-14a4 4 0 0 1 4-4z" fill="#c26d52" />
        <ellipse cx="81" cy="56" rx="18" ry="5" fill="#f0dfba" />
      </g>
      {/* base */}
      <rect x="22" y="134" width="38" height="10" rx="5" fill="#35322d" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 150 70" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s cubic-bezier(.34,1.56,.64,1)', transform: active ? 'translateY(-7px)' : 'none' }}>
        ...
        {(active || seen) && <rect x="20" y="2" width="34" height="12" rx="2" fill="#fdfbf6" stroke="#d8cfbd" transform="rotate(-4 37 8)" />}
        {seen && <rect x="104" y="4" width="22" height="10" rx="2" fill="#d3a955" transform="rotate(5 115 9)" />}
      </g>
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 120 80" className="w-full overflow-visible" aria-hidden="true">
      ...
      <g style={{ transition: 'transform 0.35s cubic-bezier(.34,1.56,.64,1)', transform: active ? 'translateY(-10px) rotate(-8deg)' : 'none', transformOrigin: '60px 45px' }}>
        <path d="M12 48 L106 16 L66 62 Z" fill="#fdfbf6" stroke="#d8cfbd" strokeWidth="1.5" />
        ...
        <path d="M78 32c0-2.4 2-4 4-4s4 1.6 4 4c0 3.2-4 5.6-4 5.6s-4-2.4-4-5.6z" fill="#c26d52" opacity="0.9" />
      </g>
      {active && (
        <path d="M14 62q10-4 20-1" stroke="#9db6c6" strokeWidth="2" strokeDasharray="4 4" fill="none" strokeLinecap="round" />
      )}
    </svg>
  )
}
...
export function CalendarSvg({ active = false }) {
  ...
  return (
    <svg viewBox="0 0 90 100" className="w-full" aria-hidden="true">
      ...
      {/* page */}
      <rect x="16" y="18" width="58" height="70" rx="7" fill="#fdfbf6" stroke="#e0d7c5" strokeWidth="1.5" />
      {/* spiral rings */}
      {[0, 1, 2, 3, 4].map((i) => (
        <circle key={i} cx={26 + i * 9.5} cy="18" r="2.6" fill="none" stroke="#6f6a61" strokeWidth="1.8" />
      ))}
      {/* month band */}
      <rect x="16" y="22" width="58" height="16" rx="5" fill="#c26d52" />
      <text x="45" y="34" textAnchor="middle" fontSize="11" fontWeight="800" fill="#f7f1e6" fontFamily="inherit" letterSpacing="2">
        {month}
      </text>
      {/* today's date */}
      ...
      {/* scribbled note */}
      <path d="M28 78 q8 3 16 0 q8 -3 18 1" stroke={active ? '#a05138' : '#c9c2b4'} strokeWidth="2" fill="none" strokeLinecap="round" style={{ transition: 'stroke 0.3s' }} />
      {/* page curl */}
