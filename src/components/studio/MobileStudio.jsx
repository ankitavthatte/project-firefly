  ...
  return (
    <main className="mx-auto max-w-md px-4 pt-24 pb-24">
      ...
      >
        {night ? (
          <>
            <div className="absolute top-3 right-5 h-7 w-7 rounded-full bg-[#faf0d9] shadow-[0_0_16px_6px_rgba(255,243,214,0.4)]" />
      ...
      {/* names the place the mini-window looks out on */}
      <p className="mt-1.5 flex items-center gap-1 pl-2 font-hand text-base text-ink-soft">
        <span aria-hidden="true">📍</span> Pune
      </p>
